...
import seederData from "./creditNote.seeder.json";
...
const CreditNoteSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CreditNoteSeederDialogComponent);
