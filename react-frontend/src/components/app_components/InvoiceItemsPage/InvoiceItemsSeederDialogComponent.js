...
import seederData from "./invoiceItems.seeder.json";
...
const InvoiceItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(InvoiceItemsSeederDialogComponent);
