...
import seederData from "./quotations.seeder.json";
...
const QuotationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(QuotationsSeederDialogComponent);
