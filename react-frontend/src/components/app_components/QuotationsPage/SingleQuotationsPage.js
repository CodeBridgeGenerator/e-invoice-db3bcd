  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Quotation ID</label><p className="m-0 ml-3" >{Number(_entity?.quotationID)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Total Amount</label><p className="m-0 ml-3" >{Number(_entity?.totalAmount)}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Purchase Orders" leftIcon="pi pi-building-columns mr-2">
                        <PurchaseOrdersPage/>
                    </TabPanel>
