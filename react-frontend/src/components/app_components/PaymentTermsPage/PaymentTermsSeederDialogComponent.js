...
import seederData from "./paymentTerms.seeder.json";
...
const PaymentTermsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PaymentTermsSeederDialogComponent);
