...
const PaymentsPage = (props) => {
    ...
    useEffect(() => {
        const _getSchema = async () => {
            const _schema = await props.getSchema("payments");
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="payments-add-button"/>
...
/>            
      ...
      />
            ...
            <PaymentsCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
