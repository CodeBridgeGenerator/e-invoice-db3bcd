...
import seederData from "./receipts.seeder.json";
...
const ReceiptsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ReceiptsSeederDialogComponent);
