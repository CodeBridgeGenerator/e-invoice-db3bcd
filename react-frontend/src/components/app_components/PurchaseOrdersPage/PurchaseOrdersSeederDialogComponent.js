...
import seederData from "./purchaseOrders.seeder.json";
...
const PurchaseOrdersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PurchaseOrdersSeederDialogComponent);
