...
const SinglePurchaseOrdersPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singlePurchaseOrdersId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singlePurchaseOrdersId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Purchase Orders</h3>
                    <SplitButton
                ...
                {/* <p>purchaseOrders/{urlParams.singlePurchaseOrdersId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">POAmount</label><p className="m-0 ml-3" >{_entity?.POAmount}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singlePurchaseOrdersId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SinglePurchaseOrdersPage);
