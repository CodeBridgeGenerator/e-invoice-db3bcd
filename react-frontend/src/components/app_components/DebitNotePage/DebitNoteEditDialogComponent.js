...
const DebitNoteEditDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            debitNoteID: _entity?.debitNoteID,
...
amount: _entity?.amount,
        ...
        await client.service("debitNote").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info debitNote updated successfully" });
    ...
    return (
        <Dialog header="Edit Debit Note" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="debitNote-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(DebitNoteEditDialogComponent);
