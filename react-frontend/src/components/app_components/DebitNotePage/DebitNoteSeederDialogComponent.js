...
import seederData from "./debitNote.seeder.json";
...
const DebitNoteSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DebitNoteSeederDialogComponent);
