const { InvoiceItems } = require("./invoiceItems.class");
const createModel = require("./invoiceItems.model");
const hooks = require("./invoiceItems.hooks");
...
module.exports = function (app) {
  ...
  app.use("/invoiceItems", new InvoiceItems(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("invoiceItems");

  // Get the schema of the collections 
  app.get("/invoiceItemsSchema", function (request, response) {
